...
router.get("/cases", async (req, res) => {
  try {
    const cases = await store.listCases({ hydratedOnly: req.query.hydratedOnly === "true" });
    res.json({ cases });
  } catch(e) {
...
router.get("/exports/list", (req, res) => {
  res.json({
    exports: [
      { name: "Master",     url: "/exports/master",     description: "All cases and contacts in one file" },
      { name: "Principals", url: "/exports/principals", description: "Business owners and decision makers" },
      { name: "Attorneys",  url: "/exports/attorneys",  description: "Debtor attorneys grouped by unique attorney" },
      { name: "Trustees",   url: "/exports/trustees",   description: "Sub-V trustees grouped by unique trustee" },
      { name: "Review",     url: "/exports/review",     description: "Cases flagged for manual review" },
    ]
  });
});
...
router.get("/exports/master", async (req, res) => {
  try {
    ...
    logger.info(`Master CSV download: ${rowCount} rows`);
...
router.get("/exports/principals", async (req, res) => {
  try {
    ...
    logger.info(`Principals CSV download: ${rowCount} rows`);
...
router.get("/exports/attorneys", async (req, res) => {
  try {
    ...
    logger.info(`Attorneys CSV download: ${rowCount} rows`);
...
router.get("/exports/trustees", async (req, res) => {
  try {
    ...
    logger.info(`Trustees CSV download: ${rowCount} rows`);
...
router.get("/exports/review", async (req, res) => {
  try {
    ...
    logger.info(`Review CSV download: ${rowCount} rows`);
